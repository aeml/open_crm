...
func TestRetentionJobTypesRequireExplicitReview(t *testing.T) {
	want := "billing.reconcile,billing.usage.snapshot,calendar.reminder,crm.export.generate,email_sequence.send,import.execute,mailbox.sync,task.reminder,workflow.lead_follow_up,workspace.export.generate"
