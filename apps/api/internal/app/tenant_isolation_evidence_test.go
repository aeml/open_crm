...
const (
	expectedTenantIsolationEvidenceCount  = 53
	expectedTenantIsolationEvidenceDigest = "b7ee30d2f5d8fc301c14954099055bf670621f178da3bf28d9806191b6d475be"
)
...
var promotedTenantIsolationEvidence = []tenantIsolationEvidence{
	...
	{Surface: "notification-center", Source: "apps/api/internal/modules/notifications/service_postgres_test.go", Test: "TestNotificationCenterIsBoundedStableAndTenantScopedAgainstPostgres"},
	...
	{Surface: "scheduled-report-delivery", Source: "apps/api/internal/modules/customreports/schedule_postgres_test.go", Test: "TestScheduledReportDeliveryIsTenantSafeDurableAndRecoverable"},
	...
	{Surface: "deal-workflow-expected-close-date", Source: "apps/api/internal/modules/workflowautomations/deal_expected_close_date_postgres_test.go", Test: "TestDealExpectedCloseDateIsTransactionalIdempotentAndTenantScopedAgainstPostgres"},
	{Surface: "deal-workflow-sequence-enrollment", Source: "apps/api/internal/modules/workflowautomations/deal_sequence_enrollment_postgres_test.go", Test: "TestDealSequenceEnrollmentIsTransactionalIdempotentAndTenantBoundAgainstPostgres"},
	...
	{Surface: "durable-crm-export", Source: "apps/api/internal/modules/exports/async_postgres_test.go", Test: "TestDurableCRMExportLifecycleAgainstPostgres"},
	{Surface: "email-template-management", Source: "apps/api/internal/modules/emailtemplates/management_postgres_test.go", Test: "TestEmailDefinitionCatalogsAreBoundedTenantSafeRevisionedAndCapacitySerialized"},
