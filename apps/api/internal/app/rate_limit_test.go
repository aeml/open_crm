...
func TestEveryPublicMutationAndTokenSurfaceUsesAnExplicitAbuseBudget(t *testing.T) {
	testCases := []struct {
		...
		{http.MethodGet, "/api/public/quotes/demo/pdf", "public.quote-pdf", publicReadRateLimit, publicRateWindow},
		{http.MethodPost, "/api/public/quotes/demo/receipt", "public.quote-receipt", publicWriteRateLimit, publicRateWindow},
		{http.MethodPost, "/api/public/quotes/demo/signature", "public.quote-signature", publicWriteRateLimit, publicRateWindow},
		{http.MethodPost, "/api/public/quotes/demo/decline", "public.quote-decline", publicWriteRateLimit, publicRateWindow},
		{http.MethodGet, "/api/public/quotes/demo/signature-certificate", "public.quote-signature-certificate", publicReadRateLimit, publicRateWindow},
