...
func registerCRMRoutes(mux *http.ServeMux, dependencies Dependencies, rateLimiter rateLimitService) {
	...
	mux.HandleFunc("GET /api/companies/{companyID}/linked-contacts", func(w http.ResponseWriter, r *http.Request) {
		handleListCompanyLinkedContacts(dependencies.AuthService, dependencies.CompaniesService, w, r)
	})
	mux.HandleFunc("PUT /api/companies/{companyID}/linked-contacts/{contactID}", func(w http.ResponseWriter, r *http.Request) {
		handleLinkCompanyContact(dependencies.AuthService, dependencies.CompaniesService, w, r)
	})
	mux.HandleFunc("DELETE /api/companies/{companyID}/linked-contacts/{contactID}", func(w http.ResponseWriter, r *http.Request) {
		handleUnlinkCompanyContact(dependencies.AuthService, dependencies.CompaniesService, w, r)
	})
	...
	mux.HandleFunc("POST /api/deals/{dealID}/quotes/{quoteID}/reissue", func(w http.ResponseWriter, r *http.Request) {
		handleReissueExpiredDealQuote(dependencies.AuthService, dependencies.DealsService, w, r)
	})
	...
	mux.HandleFunc("POST /api/deals/{dealID}/quotes/{quoteID}/approval", func(w http.ResponseWriter, r *http.Request) {
		handleDecideQuoteApproval(dependencies.AuthService, dependencies.DealsService, w, r)
	})
	mux.HandleFunc("GET /api/deal-quote-approvals", func(w http.ResponseWriter, r *http.Request) {
		handleListPendingQuoteApprovals(dependencies.AuthService, dependencies.DealsService, w, r)
	})
