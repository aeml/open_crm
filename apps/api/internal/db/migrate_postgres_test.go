...
func TestRunMigrationsAgainstPostgres(t *testing.T) {
	...
	for _, constraint := range []string{
		...
		"workflow_automation_runs_causality_shape_check",
		...
		"custom_report_dashboards_org_id_unique",
		"custom_report_dashboards_updater_membership_fk",
		...
		"custom_report_dashboard_widgets_position_unique",
		"custom_report_dashboard_widgets_definition_unique",
	...
	for _, index := range []string{
		...
		"custom_report_definitions_org_id_unique",
		"idx_custom_report_dashboard_widgets_definition",
