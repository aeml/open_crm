...
//go:embed migrations/108_timeline_cursor_indexes.sql
var timelineCursorIndexesSQL string

//go:embed migrations/109_company_linked_contact_paging.sql
var companyLinkedContactPagingSQL string

//go:embed migrations/110_shared_inbox_cursor.sql
var sharedInboxCursorSQL string

//go:embed migrations/111_lead_submission_review_cursor.sql
var leadSubmissionReviewCursorSQL string

//go:embed migrations/112_workflow_definition_paging.sql
var workflowDefinitionPagingSQL string

//go:embed migrations/113_custom_report_definition_paging.sql
var customReportDefinitionPagingSQL string

//go:embed migrations/114_email_sequence_enrollment_history.sql
var emailSequenceEnrollmentHistorySQL string

//go:embed migrations/115_workflow_action_outcomes.sql
var workflowActionOutcomesSQL string

//go:embed migrations/116_email_template_definition_management.sql
var emailTemplateDefinitionManagementSQL string

//go:embed migrations/117_saved_view_management.sql
var savedViewManagementSQL string

//go:embed migrations/118_dashboard_query_indexes.sql
var dashboardQueryIndexesSQL string

//go:embed migrations/119_async_import_jobs.sql
var asyncImportJobsSQL string

//go:embed migrations/120_durable_crm_exports.sql
var durableCRMExportsSQL string

//go:embed migrations/121_workflow_approval_gates.sql
var workflowApprovalGatesSQL string

//go:embed migrations/122_workflow_causality_notifications.sql
var workflowCausalityNotificationsSQL string

//go:embed migrations/123_workflow_deal_owner_assignment.sql
var workflowDealOwnerAssignmentSQL string

//go:embed migrations/124_shared_report_dashboard.sql
var sharedReportDashboardSQL string

//go:embed migrations/125_scheduled_report_delivery.sql
var scheduledReportDeliverySQL string

//go:embed migrations/126_lead_form_custom_field_mapping.sql
var leadFormCustomFieldMappingSQL string

//go:embed migrations/127_lead_surface_revisions.sql
var leadSurfaceRevisionsSQL string

//go:embed migrations/128_custom_field_revisions.sql
var customFieldRevisionsSQL string

//go:embed migrations/129_user_catalog_paging.sql
var userCatalogPagingSQL string

//go:embed migrations/130_notification_center_indexes.sql
var notificationCenterIndexesSQL string

//go:embed migrations/131_sales_revenue_snapshots.sql
var salesRevenueSnapshotsSQL string

//go:embed migrations/132_workflow_sequence_enrollment.sql
var workflowSequenceEnrollmentSQL string

//go:embed migrations/133_workflow_expected_close_date.sql
var workflowExpectedCloseDateSQL string

func MigrationFiles() []string {
	return []string{"001_initial_schema.sql", "002_company_client_type.sql", "003_contact_client_flag.sql", "004_client_address.sql", "005_client_structured_address.sql", "006_remove_company_domain.sql", "007_task_archive.sql", "008_user_setup_tokens.sql", "009_database_integrity.sql", "010_saved_views.sql", "011_audit_events.sql", "012_user_preferences.sql", "013_notifications.sql", "014_billing_plans.sql", "015_subscription_lifecycle.sql", "016_email_templates.sql", "017_user_email_accounts.sql", "018_email_messages.sql", "019_email_open_tracking.sql", "020_email_click_tracking.sql", "021_email_sequences.sql", "022_email_sequence_enrollments.sql", "023_user_email_sync_foundation.sql", "024_inbound_email_messages.sql", "025_email_message_entity_links.sql", "026_email_message_visibility.sql", "027_email_suppressions.sql", "028_email_snippets.sql", "029_email_shared_inbox.sql", "030_call_logs.sql", "031_call_recording_controls.sql", "032_sms_foundation.sql", "033_calendar_foundation.sql", "034_calendar_booking_links.sql", "035_calendar_reminders.sql", "036_product_catalog.sql", "037_deal_line_items.sql", "038_deal_signature_requests.sql", "039_deal_pipelines.sql", "040_sales_quotas.sql", "041_currency_exchange_rates.sql", "042_lead_capture_forms.sql", "043_lead_landing_pages.sql", "044_lead_attribution.sql", "045_lead_audiences.sql", "046_marketing_email_campaigns.sql", "047_lead_nurture_campaigns.sql", "048_lead_scoring_routing.sql", "049_lead_chat_widgets.sql", "050_workflow_automations.sql", "051_workflow_automation_conditions.sql", "052_workflow_automation_actions.sql", "053_workflow_automation_runs.sql", "054_custom_report_definitions.sql", "055_custom_report_visualizations.sql", "056_background_jobs.sql", "057_mailbox_sync_jobs.sql", "058_sequence_delivery_jobs.sql", "059_user_lifecycle.sql", "060_collaboration.sql", "061_import_batches.sql", "062_bulk_operations.sql", "063_duplicate_merges.sql", "064_custom_fields.sql", "065_stage_probabilities.sql", "066_task_reminders.sql", "067_sales_activity_reporting.sql", "068_deal_close_reviews.sql", "069_sales_report_query_indexes.sql", "070_won_deal_customer_handoff.sql", "071_client_health_query_indexes.sql", "072_client_review_schedules.sql", "073_verified_workspace_signup.sql", "074_stripe_billing_lifecycle.sql", "075_billing_reconciliation.sql", "076_workspace_exports.sql", "077_billing_usage_snapshots.sql", "078_billing_capacity_reservations.sql", "079_shared_public_rate_limits.sql", "080_background_job_retention.sql", "081_deal_assignment_notifications.sql", "082_notification_retention.sql", "083_password_recovery.sql", "084_user_invitation_lifecycle.sql", "085_postmark_delivery_feedback.sql", "086_oauth_mail_delivery.sql", "087_email_sequence_approvals.sql", "088_email_sequence_outcomes.sql", "089_email_message_correlation.sql", "090_customer_email_feedback.sql", "091_email_engagement_tracking_privacy.sql", "092_email_threaded_replies.sql", "093_versioned_deal_quotes.sql", "094_deal_quote_deliveries.sql", "095_public_lead_consent_challenges.sql", "096_quote_signature_ceremony.sql", "097_signed_quote_conversion.sql", "098_quote_expiration_reissue.sql", "099_quote_fx_disclosure.sql", "100_quote_templates_approvals.sql", "101_workflow_run_operations.sql", "102_workflow_run_scheduling.sql", "103_lead_submission_review.sql", "104_audit_retention_export.sql", "105_custom_report_grouped_bar_contract.sql", "106_record_email_deliveries.sql", "107_record_email_template_tests.sql", "108_timeline_cursor_indexes.sql", "109_company_linked_contact_paging.sql", "110_shared_inbox_cursor.sql", "111_lead_submission_review_cursor.sql", "112_workflow_definition_paging.sql", "113_custom_report_definition_paging.sql", "114_email_sequence_enrollment_history.sql", "115_workflow_action_outcomes.sql", "116_email_template_definition_management.sql", "117_saved_view_management.sql", "118_dashboard_query_indexes.sql", "119_async_import_jobs.sql", "120_durable_crm_exports.sql", "121_workflow_approval_gates.sql", "122_workflow_causality_notifications.sql", "123_workflow_deal_owner_assignment.sql", "124_shared_report_dashboard.sql", "125_scheduled_report_delivery.sql", "126_lead_form_custom_field_mapping.sql", "127_lead_surface_revisions.sql", "128_custom_field_revisions.sql", "129_user_catalog_paging.sql", "130_notification_center_indexes.sql", "131_sales_revenue_snapshots.sql", "132_workflow_sequence_enrollment.sql", "133_workflow_expected_close_date.sql"}
}
...
func MigrationSQL(name string) string {
	...
	if name == "108_timeline_cursor_indexes.sql" {
		return timelineCursorIndexesSQL
	}
	if name == "109_company_linked_contact_paging.sql" {
		return companyLinkedContactPagingSQL
	}
	if name == "110_shared_inbox_cursor.sql" {
		return sharedInboxCursorSQL
	}
	if name == "111_lead_submission_review_cursor.sql" {
		return leadSubmissionReviewCursorSQL
	}
	if name == "112_workflow_definition_paging.sql" {
		return workflowDefinitionPagingSQL
	}
	if name == "113_custom_report_definition_paging.sql" {
		return customReportDefinitionPagingSQL
	}
	if name == "114_email_sequence_enrollment_history.sql" {
		return emailSequenceEnrollmentHistorySQL
	}
	if name == "115_workflow_action_outcomes.sql" {
		return workflowActionOutcomesSQL
	}
	if name == "116_email_template_definition_management.sql" {
		return emailTemplateDefinitionManagementSQL
	}
	if name == "117_saved_view_management.sql" {
		return savedViewManagementSQL
	}
	if name == "118_dashboard_query_indexes.sql" {
		return dashboardQueryIndexesSQL
	}
	if name == "119_async_import_jobs.sql" {
		return asyncImportJobsSQL
	}
	if name == "120_durable_crm_exports.sql" {
		return durableCRMExportsSQL
	}
	if name == "121_workflow_approval_gates.sql" {
		return workflowApprovalGatesSQL
	}
	if name == "122_workflow_causality_notifications.sql" {
		return workflowCausalityNotificationsSQL
	}
	if name == "123_workflow_deal_owner_assignment.sql" {
		return workflowDealOwnerAssignmentSQL
	}
	if name == "124_shared_report_dashboard.sql" {
		return sharedReportDashboardSQL
	}
	if name == "125_scheduled_report_delivery.sql" {
		return scheduledReportDeliverySQL
	}
	if name == "126_lead_form_custom_field_mapping.sql" {
		return leadFormCustomFieldMappingSQL
	}
	if name == "127_lead_surface_revisions.sql" {
		return leadSurfaceRevisionsSQL
	}
	if name == "128_custom_field_revisions.sql" {
		return customFieldRevisionsSQL
	}
	if name == "129_user_catalog_paging.sql" {
		return userCatalogPagingSQL
	}
	if name == "130_notification_center_indexes.sql" {
		return notificationCenterIndexesSQL
	}
	if name == "131_sales_revenue_snapshots.sql" {
		return salesRevenueSnapshotsSQL
	}
	if name == "132_workflow_sequence_enrollment.sql" {
		return workflowSequenceEnrollmentSQL
	}
	if name == "133_workflow_expected_close_date.sql" {
		return workflowExpectedCloseDateSQL
	}
	return ""
}
