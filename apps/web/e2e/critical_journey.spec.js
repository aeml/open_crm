...
test('pilot lead-to-client journey persists data and isolates tenants', async ({ browser, page }) => {
  ...
  await finalizedQuoteRow.getByRole('checkbox', { name: 'Request electronic signature from Avery Buyer' }).check()
  await finalizedQuoteRow.getByRole('button', { name: 'Send signature request' }).click()
  ...
  await expect(deliveredQuoteRow.getByText('Electronic signature: Signed', { exact: false })).toBeVisible()
