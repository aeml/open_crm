...
test('pilot lead-to-client journey persists data and isolates tenants', async ({ browser, page }) => {
  ...
  await page.getByLabel('Terms').fill('Net 30. Scope changes require written approval.')
  ...
  await finalizedQuoteRow.getByText('Deliver by email', { exact: true }).click()
  await finalizedQuoteRow.getByRole('checkbox', { name: 'Request signature from Avery Buyer' }).check()
  await finalizedQuoteRow.getByRole('button', { name: 'Send for signature' }).click()
