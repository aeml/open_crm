...
test('critical public and authenticated surfaces meet automated WCAG A/AA rules', async ({ page }) => {
  ...
  const authenticatedSurfaces = [
    ...
    ['/mailbox', 'Mailbox', 'mailbox-privacy'],
    ['/team-inbox', 'Team Inbox', 'shared-inbox-coordination'],
    ...
    ['/settings/audit', 'Audit Trail', 'audit-retention-and-export'],
    ['/settings/lead-forms', 'Lead Forms', 'lead-submission-review'],
