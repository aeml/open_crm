  ...
  return (
    <section className="dashboard-grid settings-grid">
      ...
      {canManage ? (
        ...
        >
          <ControlledTextField label="Name" name="name" form={form} setForm={setForm} placeholder="Demo campaign page" maxLength="100" required />
          <ControlledTextField label="Slug" hint="Public URL path, globally unique across hosted pages." name="slug" form={form} setForm={setForm} placeholder="demo-request" maxLength="80" />
          <ControlledTextField label="Title" name="title" form={form} setForm={setForm} placeholder="Book a better CRM demo" maxLength="200" />
          <ControlledTextField label="Subtitle" name="subtitle" form={form} setForm={setForm} placeholder="A focused page for one offer or campaign." maxLength="500" />
          <ControlledTextField label="Body" name="body" form={form} setForm={setForm} multiline rows={5} placeholder="Explain the offer, audience, and next step." maxLength="10000" />
