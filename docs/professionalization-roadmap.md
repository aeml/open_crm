...
CSS. Current production-URL evidence is 178.83 KiB/57.97 KiB for the entry, 54.67 KiB/15.59 KiB
for the largest lazy chunk, and 711.94 KiB/222.81 KiB total assets. The exact
template-preview/test-to-self outcome raised only the aggregate raw ceiling
from 710 to 713 KiB after consolidating the three record-send clients; every
other byte and source ceiling remains unchanged. The isolated
