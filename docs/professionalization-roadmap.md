...
- `1.1.5` (template merge-field catalog): complete. Added an authenticated merge-field catalog for contact/company/deal email tokens and surfaced it in Settings > Email Templates plus the record email composer so users do not need to memorize supported placeholders. Separate snippet objects remain future template UX polish.
...
- `1.1.5` Email templates, snippets, and merge fields. Template CRUD and merge-field catalog are complete; separate reusable snippets remain future polish.
