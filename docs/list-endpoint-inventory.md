...
- Standalone notes and contact/company/deal/task activity now use one bounded
  ...
  are the fixed newest-50 lead-submission review queue and mutable definition
  catalogs without stored-row ceilings. Shared inbox now has snapshot-bound
  visible continuation over its mutable open/closed queue.
