...
- immutable release, expand-migration, pre-restart database-credential drift refusal, manual rollback, failed-readiness recovery, and database-unavailable startup recovery acceptance
