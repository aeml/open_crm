...
- Saved contact, company, deal, and task table reports with typed filters, optional grouping/aggregation, tenant and archived-row isolation, bounded pagination/query time, and accessible result tables; chart, dashboard, sharing, export, and scheduling outcomes remain hidden foundations
