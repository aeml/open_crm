...
- Saved contact, company, deal, and task table reports with typed filters, optional grouping/aggregation, tenant and archived-row isolation, bounded pagination/query time, accessible result tables, and owner/admin audited formula-safe CSV downloads with an explicit 10,000-row ceiling; chart, dashboard, sharing, and scheduling outcomes remain hidden foundations
