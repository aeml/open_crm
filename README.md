...
- Admin-managed task automations that create one assigned, auditable, idempotent follow-up task on deal creation, a real stage change, deal archive, or a matching public lead-form submission; lead rules snapshot whether they apply to one exact active form or every active form, plus the optional attribution condition, active assignee, wording, and due date before durable execution
